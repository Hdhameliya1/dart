...
void main() {
  ...
  performance.arithmeticalope();
  performance.relationalope();
  performance.assignmentope();
  performance.logicalope();
  performance.unaryope();
  performance.bitwiseope();
  performance.conditionalope();
}
